...
public class RedFrameGrabber extends OpenCvPipeline {
    ...
    private Mat yellowMask3 = new Mat();
    ...
    public Mat processFrame(Mat rgba) {
        ...
        Imgproc.rectangle(workingMat, new Point(0, mask3), new Point(rgba.width(), 0), new Scalar(255, 255, 255), -1, 8, 0);
        Imgproc.rectangle(rgba, new Point(mask3, 0), new Point(0, rgba.height()), new Scalar(255, 255, 255), -1, 8, 0);
        // Generate Masks
        ...
        colorFilter.processFrame(workingMat.clone(), yellowMask3, mask3, threshold);
        ...
        Imgproc.blur(yellowMask3, yellowMask3, new Size(4, 4));
        ...
        Imgproc.drawContours(rgba, contoursYellow, -1, new Scalar(230, 70, 70), 2);
        Imgproc.findContours(yellowMask3, contoursYellow, hiarchy, Imgproc.RETR_TREE, Imgproc.CHAIN_APPROX_SIMPLE);
        Imgproc.drawContours(rgba, contoursYellow, -1, new Scalar(230, 70, 70), 2);
        ...
        if (chosenYellowRect != null) {
            ...
            Imgproc.putText(rgba,
                    ...
                    2);
            Imgproc.putText(rgba,
                    calcAlign(chosenYellowRect.x, chosenYellowRect.width),
                    new Point(100, 100),
                    Imgproc.FONT_HERSHEY_PLAIN,
                    5,
                    new Scalar(0, 255, 255),
    ...
    */
      ...
      public String calcAlign(double x, double width){
          rectWidth = width;
